...
@pytest.mark.asyncio
async def test_qwen_native_transport_recovers_after_superseding_navigation_wait_timeout() -> None:
    class FakeContext:
        async def add_cookies(self, _cookies: list[dict[str, str]]) -> None:
            return None
    ...
    class FakePage:
        ...
        async def wait_for_url(self, _url: str, **_kwargs: object) -> None:
            raise RuntimeError("Page.wait_for_url: Timeout 10000ms exceeded")
